...
public class App1_index_create {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Book b : bookList){
             ...
             *    参数3：是否存储域的信息。
             */
            document.add(new TextField("id",b.getId()+"", Field.Store.YES));
            document.add(new TextField("bookname",b.getBookname()+"", Field.Store.YES));
            document.add(new TextField("price",b.getPrice()+"", Field.Store.YES));
            document.add(new TextField("pic",b.getPic()+"", Field.Store.YES));
            document.add(new TextField("bookdesc",b.getBookdesc()+"", Field.Store.YES));
